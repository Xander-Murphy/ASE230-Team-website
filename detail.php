...
<html lang="en"> 
<head>
    <title><?php echo $member['name']. "'s profile";?></title>
    ...
    <article class="resume-wrapper text-center position-relative">
	    ...
	    <div class="resume-wrapper-inner mx-auto text-start bg-white shadow-lg">
					    ...
					    <div class="row p-4 justify-content-center justify-content-md-between">
						    ...
						    <div class="secondary-info col-auto mt-2">
							    <ul class="resume-social list-unstyled">
					                ...
					                <li><a class="text-link" href="<?php echo $member['gitHub'];?>"><span class="fa-container text-center me-2"><i class="fas fa-globe"></i></span><?php echo $member['gitHub'];?></a></li>
							    </ul>
						    </div><!--//secondary-info-->
					    </div><!--//row-->
		    ...
		    <div class="resume-body p-5">
				    ...
				    <div class="col-lg-3">
						    ...
						    <div class="resume-section-content">
						        <div class="resume-skill-item">
							        <ul class="list-unstyled mb-4">
								        <li class="mb-2">
								            <div class="resume-skill-name"><?php echo $member['skills'][0]?></div>
									        <div class="progress resume-progress">
											    <div class="progress-bar theme-progress-bar-dark" role="progressbar" style="width: 98%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
											</div>
								        </li>
								        <li class="mb-2">
								            <div class="resume-skill-name"><?php echo $member['skills'][1]?></div>
									        <div class="progress resume-progress">
								        ...
								        <li class="mb-2">
								            <div class="resume-skill-name"><?php echo $member['skills'][2]?></div>
									        <div class="progress resume-progress">
								        ...
								        <li class="mb-2">
								            <div class="resume-skill-name"><?php echo $member['skills'][3]?></div>
									        <div class="progress resume-progress">
								        ...
								        <li class="mb-2">
								            <div class="resume-skill-name"><?php echo $member['skills'][4]?></div>
									        <div class="progress resume-progress">
											    <div class="progress-bar theme-progress-bar-dark" role="progressbar" style="width: 96%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
											</div>
								        </li>
						        ...
						        <div class="resume-skill-item">
						            ...
						            <ul class="list-inline">
							            <li class="list-inline-item"><span class="badge badge-light"><?php echo $member['skills'][5]?></span></li>
							            <li class="list-inline-item"><span class="badge badge-light"><?php echo $member['skills'][6]?></span></li>
							            <li class="list-inline-item"><span class="badge badge-light"><?php echo $member['skills'][7]?></span></li>
							            <li class="list-inline-item"><span class="badge badge-light"><?php echo $member['skills'][8]?></span></li>
							            <li class="list-inline-item"><span class="badge badge-light"><?php echo $member['skills'][9]?></span></li>
							            <li class="list-inline-item"><span class="badge badge-light"><!--CAN ADD MORE--></span></li>
							            <li class="list-inline-item"><span class="badge badge-light"><!--CAN ADD MORE--></span></li>
							            <li class="list-inline-item"><span class="badge badge-light"><!--CAN ADD MORE--></span></li>
							            <li class="list-inline-item"><span class="badge badge-light"><!--CAN ADD MORE--></span></li>
						            </ul>
					    ...
					    <section class="resume-section education-section mb-5">
						    ...
						    <div class="resume-section-content">
							    <ul class="list-unstyled">
								    <li class="mb-2">
								        <div class="resume-degree font-weight-bold"><?php echo $member['currentEducation'];?></div>
								        <div class="resume-degree-org"><?php echo $member['currentEducationLocation']?></div>
								        <div class="resume-degree-time"><?php echo $member['collegeDuration']?></div>
								    </li>
								    <li>
								        <div class="resume-degree font-weight-bold"><?php echo $member['highSchoolEducation']?></div>
								        <div class="resume-degree-org"><?php echo $member['highSchoolEducationLocation']?></div>
								        <div class="resume-degree-time"><?php echo $member['highSchoolDuration']?></div>
								    </li>
							    </ul>
						    </div>
						    ...
						    <div class="resume-section-content">
							    <ul class="list-unstyled resume-awards-list">
								    <li class="mb-2 ps-4 position-relative">
								        ...
								        <div class="resume-award-name"><?php echo $member['award1Name']?></div>
								        <div class="resume-award-desc"><?php echo $member['award1Description']?></div>
								    </li>
								    <li class="mb-0 ps-4 position-relative">
								        <!--<i class="resume-award-icon fas fa-trophy position-absolute" data-fa-transform="shrink-2"></i>-->
								        <div class="resume-award-name"><!--CAN ADD MORE--></div>
								        <div class="resume-award-desc"><!--CAN ADD MORE--></div>
								    </li>
							    </ul>
						    </div>
					    ...
					    <section class="resume-section language-section mb-5">
						    ...
						    <div class="resume-section-content">
							    <ul class="list-unstyled resume-lang-list">
								    <li class="mb-2"><span class="resume-lang-name font-weight-bold"><?php echo $member['primaryLang']?></span> <small class="text-muted font-weight-normal"><?php echo $member['primaryLevel']?></small></li>
								    <li class="mb-2 align-middle"><span class="resume-lang-name font-weight-bold"><?php echo $member['secondaryLang']?></span> <small class="text-muted font-weight-normal"><?php echo $member['secondaryLevel']?></small></li>
					    ...
					    <section class="resume-section interests-section mb-5">
						    ...
						    <div class="resume-section-content">
							    <ul class="list-unstyled">
								    <li class="mb-1"><?php echo $member['interests'][0]?></li>
								    <li class="mb-1"><?php echo $member['interests'][1]?></li>
								    <li class="mb-1"><?php echo $member['interests'][2]?></li>
							    </ul>
						    </div>
					    </section><!--//interests-section-->
				...
				<?php if (!empty($member['project1Name'])): ?>
				<section class="resume-section experience-section mb-5">
					...
					<div class="row mt-4">
						<div class="col-md-4">
							<div class="card">
								...
								<div class="card-body">
									<h5 class="card-title"><?php echo $member['project1Name']?></h5>
									<p class="card-text"><?php echo $member['project1Desc']?></p>
									<a href="btn btn-outline-primary" href="<?php echo $member['project1Link']?>"><?php echo $member['project1Link']?></a>
								</div>
							</div>
						</div>
					</div>
